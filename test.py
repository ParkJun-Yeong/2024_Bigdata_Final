...
from datasets.dataset_vfss import Vfss_dataset
...
def inference(args, multimask_output, db_config, model, test_save_path="/mnt/ssd01_250gb/juny/vfss/SAMed/output"):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/mnt/ssd03_4tb/juny/vfss/vfss_cauh/experiment/train')
    parser.add_argument('--dataset', type=str, default='Vfss', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=1)
    parser.add_argument('--list_dir', type=str, default='/mnt/ssd01_250gb/juny/vfss/SAMed/lists/lists_vfss/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/mnt/ssd01_250gb/juny/vfss/SAMed/output/')
    ...
    parser.add_argument('--lora_ckpt', type=str, help='The checkpoint from LoRA')
